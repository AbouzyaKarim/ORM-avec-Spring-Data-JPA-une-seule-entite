...
public class JpaApApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (int i=0; i < 100 ;i++){
            patientRepository.save(new Patient(0,"hassan",new Date(),Math.random()>0.5?true:false,(int)(Math.random()*1000)));
        }
        ...
        List<Patient> patientList = patientRepository.chercherPatients("%h%", 42);
